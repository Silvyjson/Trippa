...
const Filter = () => {
    ...
    return (
        <div className='filter fixed bottom-0 hidden flex-col gap-3 p-[30px] w-full h-[60%] bg-page_color z-30 rounded-tl-[20px] rounded-tr-[20px] lg:w-[1000px]' ref={filterRef}>
